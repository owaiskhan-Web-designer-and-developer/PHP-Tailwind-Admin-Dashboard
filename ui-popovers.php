            ...
            <main>
                ...
                <div class="container py-6">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="flex flex-wrap gap-3">
                                    <div class="hs-tooltip inline-block [--trigger:click] [--placement:top]">
                                        <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                                            ...
                                            <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible transition-opacity opacity-0 relative hidden px-3 py-1 rounded bg-default-800 text-default-200 font-medium w-60 z-50"
                                                role="tooltip">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="text-lg font-medium text-default-950 capitalize mb-1">Focus</h5>
                            </div>
                            <div class="card-body">
                                <div class="flex flex-wrap gap-3">
                                    <div class="hs-tooltip inline-block [--trigger:focus] [--placement:top]">
                                        <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                                            <div
                                                class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">
                                                Focus on me
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="text-lg font-medium text-default-950 capitalize mb-1">Popover With Content
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="flex flex-wrap gap-3">
                                    <div class="hs-tooltip inline-block [--trigger:focus] [--placement:bottom-left]">
                                        <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                                            <div
                                                class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-primary-700 border-primary hover:border-primary-700 text-white rounded-md">
                                                Focus on me
                                            ...
                                            <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-70 max-w-xs bg-white border border-default-200 text-start rounded-lg shadow-md"
                                                role="tooltip">
                                                <span
                                                    class="pt-3 px-4 block text-lg font-bold text-default-800">Overview</span>
                                                <div class="py-3 px-4 text-sm text-default-600">
                                                    <svg class="rounded-lg mb-3" viewBox="0 0 500 300" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="500" height="300"
                                                            class="text-default-300 fill-current" />
                                                        <path
                                                            d="M215.232 131.849L237.249 58.489C237.723 56.9116 239.379 56.0108 240.961 56.4707L309.463 76.3953C311.062 76.8604 311.977 78.5394 311.499 80.1352L289.482 153.776C289.009 155.36 287.344 156.262 285.759 155.794L217.256 135.589C215.662 135.119 214.754 133.442 215.232 131.849Z"
                                                            fill="#9CA3AF" />
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M208.527 129.837L230.545 56.4768C232.123 51.2189 237.644 48.2161 242.916 49.7493L311.418 69.6738C316.749 71.2244 319.796 76.821 318.206 82.1404L311.499 80.1352C311.977 78.5394 311.062 76.8604 309.463 76.3953L240.961 56.4707C239.379 56.0108 237.723 56.9116 237.249 58.489L215.232 131.849L208.527 129.837ZM215.232 131.849L208.527 129.837C206.934 135.145 209.961 140.735 215.276 142.303L283.779 162.508C289.062 164.067 294.611 161.059 296.189 155.781L318.206 82.1404L311.499 80.1352L289.482 153.776C289.009 155.36 287.344 156.262 285.759 155.794L217.256 135.589C215.662 135.119 214.754 133.442 215.232 131.849Z"
                                                            fill="white" />
                                                        <path
                                                            d="M226.24 116.95L242.101 64.4837C242.577 62.9087 244.233 62.0111 245.813 62.4718L303.489 79.2932C305.078 79.7567 305.991 81.4199 305.53 83.0097L290.216 135.75C289.753 137.345 288.082 138.26 286.489 137.792L228.267 120.697C226.668 120.227 225.758 118.545 226.24 116.95Z"
                                                            fill="white" />
                                                        <path
                                                            fill="#D1D5DB" />
                                                        <path
                                                            d="M196.767 98.065L220.319 90.64L208.904 129.668C207.359 134.952 210.375 140.491 215.653 142.06L252.365 152.973L217.056 164.47C211.716 166.208 205.992 163.21 204.38 157.831L190.194 110.472C188.625 105.235 191.553 99.7088 196.767 98.065Z"
                                                            fill="#9CA3AF" />
                                                        <path
                                                    ...
                                                    <dl class="mt-3">
                                                        ...
                                                        <dd class="text-default-600">Mark Welson</dd>
                                                        <dt class="font-bold pt-3 first:pt-0">Due:</dt>
                                                        <dd class="text-default-600">December 21, 2021</dd>
                                                    </dl>
                                                </div>
                                            </div>
                                        </a>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="text-lg font-medium text-default-950 capitalize mb-1">User popover Example
                                </h5>
                            </div>
                            <div class="card-body">
                                <!-- User -->
                                <div class="hs-tooltip [--trigger:hover] sm:[--placement:right] inline-block">
                                    <div
                                        ...
                                        <!-- User Content -->
                                        <div class="grow">
                                            <h4 class="font-semibold text-sm text-default-800">
                                                Amanda Harvey
                                            </h4>
                                            <p class="text-sm text-default-800 md:text-default-500 md:">
                                                amanda@email.com
                                            </p>
                                        </div>
                                        <!-- End User Content -->
                                        ...
                                        <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-10 max-w-xs w-full bg-white border border-gray-100 text-start rounded-xl shadow-md after:absolute after:top-0 after:-start-4 after:w-4 after:h-full"
                                            ...
                                            <div class="py-3 px-4 border-b border-gray-200">
                                                <div class="flex items-center gap-x-3">
                                                    <img class="flex-shrink-0 inline-block size-10 rounded-full ring-2 ring-white"
                                                        src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                                    <div class="grow">
                                                        <h4 class="font-semibold text-default-800">
                                                            Amanda Harvey
                                                            <span
                                                                class="ms-0.5 inline-flex items-center align-middle gap-x-1.5 py-0.5 px-1.5 rounded-md text-[11px] font-medium bg-gray-800 text-white">
                                                                PRO
                                                            </span>
                                                        </h4>
                                            ...
                                            <ul class="py-3 px-4 space-y-1">
                                                <li>
                                                    <div
                                                        class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                                        <i class="i-tabler-building text-base text-default-600"></i>
                                                        Pixeel Ltd.
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div
                                                        class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                                        <i
                                                            class="i-tabler-device-mobile text-base text-default-600"></i>
                                                        (892) 312-5483
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div
                                                        class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                                        <i class="i-tabler-mail text-base text-default-600"></i>
                                                        amanda@email.com
                                                    </div>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="py-2 px-4 flex justify-between items-center bg-gray-100">
                                                <a class="inline-flex items-center gap-x-1.5 text-xs text-default-500 hover:text-primary disabled:opacity-50 disabled:pointer-events-none"
                                                    href="#">
                                                    <i class="i-tabler-flag text-base"></i>
                                                    Flag
                                                </a>

                                                <button type="button" class="btn bg-primary text-white">Follow</button>
                                            </div>
                                            <!-- End Footer -->
                                        </div>
                                        <!-- End Popover Content -->
