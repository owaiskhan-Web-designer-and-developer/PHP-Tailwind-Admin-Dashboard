                            ...
                            <div class="p-6">
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <small id="emailHelp" class="form-text text-sm text-default-700">We'll never
                                            share your email
                                ...
                                <form class="flex flex-col gap-3">
                                    ...
                                    <div class="grid grid-cols-4 items-center gap-6">
                                        <label for="inputPassword5"
                                            class="text-default-800 text-sm font-medium inline-block mb-2">Re
                                            Password</label>
                                        <div class="md:col-span-3">
                                            <input type="password" class="form-input" id="inputPassword5"
                                        ...
                                        <div class="md:col-start-2">
                                            <div class="flex items-center gap-2">
                                                <input type="checkbox"
                                                    ...
                                                    id="checkmeout">
                                                <label class="text-default-800 text-sm font-medium inline-block"
                                                    for="checkmeout">Check me out !</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-4 items-center gap-6">
                            ...
                            <div class="card">
                                <div class="p-6">
                                    ...
                                    <p class="text-sm text-default-700 mb-4">
                                        ...
                                        number of a <code class="text-primary">.grid-cols-*</code> and <code
                                            class="text-primary">.flex</code>
                                    </p>
                                    ...
                                    <form class="grid grid-cols-4 gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="password" class="form-input" id="inputPassword2"
                                                placeholder="Password">
                                        </div>
                                        <div>
                                            <button type="submit" class="btn bg-primary text-white">Confirm
                                                identity</button>
                                        </div>
                                    </form>
                                    ...
                                    <form>
                                        <div class="flex flex-wrap items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="flex">
                                                    <span
                                                        class="px-4 inline-flex items-center min-w-fit rounded-l border border-e-0 border-gray-200 bg-gray-50 text-sm text-default-500">@</span>
                        ...
                        <div class="col-span-2">
                            <div class="card">
                                <div class="p-6">
                                    ...
                                    <p class="text-sm text-default-700 mb-4">More complex layouts can also be created
                                    ...
                                    <form>
                                        <div class="grid grid-cols-1 md:grid-cols-2  gap-6">
                                            ...
                                            <div class="lg:col-span-2">
                                                <label for="inputAddress"
                                                    class="text-default-800 text-sm font-medium inline-block mb-2">Address</label>
                                            ...
                                            <div>
                                                <label for="inputAddress2"
                                                    class="text-default-800 text-sm font-medium inline-block mb-2">Address
                                                    2</label>
                                        ...
                                        <div class="flex items-center gap-2 my-3">
                                            <input type="checkbox" class="form-checkbox rounded border border-gray-200"
                                                id="customCheck11">
                                            <label class="text-default-800 text-sm font-medium inline-block"
                                                for="customCheck11">Check this custom checkbox !</label>
                                        </div>
