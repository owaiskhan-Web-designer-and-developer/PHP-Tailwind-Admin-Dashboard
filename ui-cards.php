                ...
                <div class="container py-6">
                    ...
                    <div class="grid 2xl:grid-cols-4 grid-cols-1 gap-6">
                        ...
                        <div class="card">
                            ...
                            <img class="w-full h-auto rounded-b-xl" src="assets/images/small/img-4.jpg"
                                alt="Image Description">
                        </div>

                        <div class="card">
                            <img class="w-full h-auto rounded-xl" src="assets/images/small/img-2.jpg"
                                alt="Image Description">
                        ...
                        <div class="card p-4 md:p-5">
                            ...
                            <a class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-primary hover:text-primary-800 disabled:opacity-50 disabled:pointer-events-none"
                                href="#">
                                Card link
                        ...
                        <a class="card group overflow-hidden hover:shadow-lg transition" href="#">
                            <div class="relative pt-[50%] sm:pt-[60%] lg:pt-[80%] rounded-t-xl overflow-hidden">
                                <img class="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl"
                                    src="assets/images/small/img-4.jpg" alt="Image Description">
                            </div>
                            <div class="p-4 md:p-5">
                                <h3 class="text-lg font-bold text-default-800">
                                    Card title
                    ...
                    <div>
                        <div
                            class="grid border rounded-xl shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x">
                            ...
                            <div class="flex flex-col flex-[1_0_0%] bg-white">
                                <img class="w-full h-auto sm:rounded-se-xl"
                                    src="https://images.unsplash.com/photo-1680868543815-b8666dba60f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2532&q=80"
                                    alt="Image Description">
                                <div class="p-4 flex-1 md:p-5">
                                    <h3 class="text-lg font-bold text-default-800">
